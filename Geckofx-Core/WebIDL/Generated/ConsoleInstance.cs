namespace Gecko.WebIDL
{
    ...
    public class ConsoleInstance : WebIDLBase
    {
        
        public ConsoleInstance(mozIDOMWindowProxy globalWindow, nsISupports thisObject) : 
        ...
        public void ReportForServiceWorkerScope(string scope, string message, string filename, uint lineNumber, uint columnNumber, ConsoleLevel level)
        {
            this.CallVoidMethod("reportForServiceWorkerScope", scope, message, filename, lineNumber, columnNumber, level);
        }
    }
}
