namespace Gecko.WebIDL
{
    ...
    public class WindowOrWorkerGlobalScope : WebIDLBase
    {
        ...
        public Promise < nsISupports > CreateImageBitmap(WebIDLUnion<nsISupports,nsISupports,nsISupports,nsIDOMBlob> aImage)
        {
            return this.CallMethod<Promise < nsISupports >>("createImageBitmap", aImage);
        }
        
        public Promise < nsISupports > CreateImageBitmap(WebIDLUnion<nsISupports,nsISupports,nsISupports,nsIDOMBlob> aImage, int aSx, int aSy, int aSw, int aSh)
        {
