namespace Gecko.WebIDL
{
    ...
    public class ImageBitmap : WebIDLBase
    {
        ...
        public Promise < Object[] > MapDataInto(ImageBitmapFormat aFormat, IntPtr aBuffer, int aOffset)
        {
            return this.CallMethod<Promise < Object[] >>("mapDataInto", aFormat, aBuffer, aOffset);
        }
    }
}
