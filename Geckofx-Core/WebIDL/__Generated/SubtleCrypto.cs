namespace Gecko.WebIDL
{
    ...
    public class SubtleCrypto : WebIDLBase
    {
        ...
        public Promise <object> Encrypt(WebIDLUnion<Object,String> algorithm, nsISupports key, IntPtr data)
        {
            return this.CallMethod<Promise <object>>("encrypt", algorithm, key, data);
        }
        
        public Promise <object> Decrypt(WebIDLUnion<Object,String> algorithm, nsISupports key, IntPtr data)
        {
            return this.CallMethod<Promise <object>>("decrypt", algorithm, key, data);
        }
        
        public Promise <object> Sign(WebIDLUnion<Object,String> algorithm, nsISupports key, IntPtr data)
        {
            return this.CallMethod<Promise <object>>("sign", algorithm, key, data);
        }
        
        public Promise <object> Verify(WebIDLUnion<Object,String> algorithm, nsISupports key, IntPtr signature, IntPtr data)
        {
            return this.CallMethod<Promise <object>>("verify", algorithm, key, signature, data);
        }
        
        public Promise <object> Digest(WebIDLUnion<Object,String> algorithm, IntPtr data)
        {
        ...
        public Promise <object> UnwrapKey(String format, IntPtr wrappedKey, nsISupports unwrappingKey, WebIDLUnion<Object,String> unwrapAlgorithm, WebIDLUnion<Object,String> unwrappedKeyAlgorithm, bool extractable, String[] keyUsages)
        {
