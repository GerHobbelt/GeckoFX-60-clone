...
namespace Gecko
{
	...
	/// <summary>nsIURLMutator </summary>
	[ComImport()]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	[Guid("25072eb8-f1e6-482f-9ca9-eddd3d65169a")]
	public interface nsIURLMutator
	{
		
		/// <summary>Member SetFileName </summary>
		/// <param name='aFileName'> </param>
		/// <returns>A nsIURIMutator</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIURIMutator SetFileName([MarshalAs(UnmanagedType.LPStruct)] nsAUTF8StringBase aFileName);
		
		/// <summary>Member SetFileBaseName </summary>
		/// <param name='aFileBaseName'> </param>
		/// <returns>A nsIURIMutator</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIURIMutator SetFileBaseName([MarshalAs(UnmanagedType.LPStruct)] nsAUTF8StringBase aFileBaseName);
		
		/// <summary>Member SetFileExtension </summary>
		/// <param name='aFileExtension'> </param>
		/// <returns>A nsIURIMutator</returns>
		[return: MarshalAs(UnmanagedType.Interface)]
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		nsIURIMutator SetFileExtension([MarshalAs(UnmanagedType.LPStruct)] nsAUTF8StringBase aFileExtension);
	}
}
