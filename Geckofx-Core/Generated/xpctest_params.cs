...
namespace Gecko
{
	...
	public interface nsIXPCTestParams
	{
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void TestOutAString([MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "Gecko.CustomMarshalers.AStringMarshaler")] nsAStringBase o);
		
		/// <summary>
        /// Test for optional array size_is.
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void TestStringArrayOptionalSize([MarshalAs(UnmanagedType.LPArray, SizeParamIndex=1)] string[] a, uint aLength, [MarshalAs(UnmanagedType.LPStruct)] nsACStringBase retval);
	}
}
