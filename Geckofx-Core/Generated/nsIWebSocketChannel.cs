...
namespace Gecko
{
	...
	public interface nsIWebSocketChannel
	{
        ...
        /// </summary>
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime)]
		void SetServerParameters([MarshalAs(UnmanagedType.Interface)] nsITransportProvider aProvider, [MarshalAs(UnmanagedType.LPStruct)] nsACStringBase aNegotiatedExtensions);
	}
